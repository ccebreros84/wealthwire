  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <header style={{
        ...
        {/* Three-column grid (see .ww-header-row) keeps the DEMO badge centred on the page. */}
        <div className="ww-header-row" style={{ maxWidth: 1320, margin: '0 auto', padding: '13px 22px' }}>
          ...
          <span style={{
            fontFamily: slab, fontSize: 11, letterSpacing: '0.14em', color: C.paper, fontWeight: 700,
